...
class xygrz extends React.Component {
            ...
            <LocaleProvider locale={zhCN}>
                <div>
                    <div style={style1}>
                        ...
                        <div className='pa' style={style}>新员工入职</div>
                    </div>
                    <div style={style2}>
                        <p className='pa'>单号</p>
                    ...
                    <div style={style2} className='top'><p className='pa'>姓名（必填）</p><input className='xingming'/></div>

                    <div className='select'>
                        <div className='select-flex' style={style4}>性别（必填）</div>
                        <Select defaultValue={global.data.usershoplist[0].name} className='select-flex'
                                onChange={this.handleChange.bind(this)}>
